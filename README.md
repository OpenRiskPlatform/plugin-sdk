...
Current data model version: `0.0.1`.
...
- `model/data-model-v0.0.1.ts` - structured source of truth for data model `0.0.1`
- `model/openrisk-types.ts` - canonical inline TypeScript helper for single-file plugins
- `schemas/data-model-v0.0.1.schema.json` - generated JSON Schema for plugin output arrays
...
backend builds to `0.0.1` at scan result serialization time.
